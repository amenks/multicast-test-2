    ...
    const map = useMapEvents({
      mousemove: e => {
        if (clickEnabled) {
          ...
          setLng(coords.lng)
          fetch(
            `https://multicast-tiles.netbistrot.com/Barcelona-trees-svf/${zoomLevel}/${xtile}/${ytile}.png`
          )
          ...
          <>
            ...
            >
              ...
              <TileLayer
                ...
                url="https://multicast-tiles.netbistrot.com/Barcelona-trees-svf/{z}/{x}/{y}.png"
